...
hero and programme copy, checked against the lab's supplied bio; five members
by name, role and photo.

Still `TODO:` on the page: course materials; paper and code URLs.
